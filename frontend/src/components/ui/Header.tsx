        ...
        <div className="block sm:hidden py-4">
          ...
          <div className="flex items-center mb-3">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent truncate">
                SwiftFab Quote System
              </h1>
            </div>
          </div>
          
          {/* Second row - Subtitle and button */}
          <div className="flex items-center justify-between">
            <p className="text-gray-500 text-xs flex-1 min-w-0 mr-3">
              Upload your STEP files for instant quotes
            </p>
            {onViewQuotes && (
              <Button
              ...
              >
                ...
                <span className="text-xs">{showQuotes ? 'Hide My Quotes' : 'View My Quotes'}</span>
              </Button>
            )}
          </div>
        </div>
